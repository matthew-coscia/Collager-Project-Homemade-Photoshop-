...
public class PixelRGB implements PixelType {
   ...
   */
  public PixelRGB(CollagerState state, CollagerController controller, CollagerModel model) {
    this.state = state;
    this.controller = controller;
    this.model = model;
    /*
   ...
   */
  public PixelRGB(PixelHSL pixelHSL, CollagerState state,
                  CollagerModel model, CollagerController controller) {
