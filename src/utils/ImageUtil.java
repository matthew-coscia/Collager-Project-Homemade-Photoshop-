...
public class ImageUtil {
   ...
   */
  public ImageUtil(CollagerState state, CollagerModel model,
  ...
  public void readPPM(String filename) {
    ...
    for (int i = 0; i < height; i++) {
      ...
      for (int j = 0; j < width; j++) {
        ...
        int g = sc.nextInt();
        int b = sc.nextInt();
        convertedPixels.get(i).add(new PixelRGB(r, g, b,
  ...
  public void readImage(String fileName) {
    ...
    try {
      ...
      this.view.communicate(e.getMessage());
      return;
    }
    ...
    for (int i = 0; i < img.getHeight(); i++) {
      ...
      for (int k = 0; k < img.getWidth(); k++) {
        ...
        tempRGB.get(i).add(new PixelRGB(red, green, blue,
                this.state, this.model, this.controller, this.view));
      }
    }
